...
namespace Forge.Threading
{
    ...
    /// </summary>
    [Serializable]
    public sealed class AtomicFloat : MBRBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AtomicFloat"/> class.
        /// </summary>
        public AtomicFloat()
        {
        }
        ...
        /// The value.
        /// </value>
        /// <exception cref="System.OverflowException">value is greater than Single.MaxValue ot less than Single.MinValue</exception>
        [DebuggerHidden]
        public long LongValue
        {
            ...
            [MethodImpl(MethodImplOptions.Synchronized)]
            set { mValue = Convert.ToSingle(value); }
        }
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        [DebuggerStepThrough]
        public float GetAndAdd(int delta)
        {
