...
namespace Forge.Threading
{
    ...
    /// </summary>
    [Serializable]
    public sealed class AtomicUShort : MBRBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AtomicUShort"/> class.
        /// </summary>
        public AtomicUShort()
        {
        }
        ...
        public AtomicUShort(ushort value)
        {
            this.mValue = value;
        }
        ...
        public long LongValue
        {
            ...
            [MethodImpl(MethodImplOptions.Synchronized)]
            set { mValue = Convert.ToUInt16(value); }
        }
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        [DebuggerStepThrough]
        public ushort GetAndSet(ushort newValue)
        {
            ushort result = mValue;
            mValue = newValue;
            return result;
        }
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        [DebuggerStepThrough]
        public ushort GetAndAdd(ushort delta)
        {
            ushort result = mValue;
            mValue = Convert.ToUInt16(mValue + delta);
            return result;
        }
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        [DebuggerStepThrough]
        public ushort AddAndGet(ushort delta)
        {
            mValue = Convert.ToUInt16(mValue + delta);
            return mValue;
        }
