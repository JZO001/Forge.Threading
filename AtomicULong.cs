...
namespace Forge.Threading
{
    ...
    /// </summary>
    [Serializable]
    public sealed class AtomicULong : MBRBase
    {
        ...
        public long LongValue
        {
            ...
            [MethodImpl(MethodImplOptions.Synchronized)]
            set { mValue = Convert.ToUInt64(value); }
        }
        ...
        /// The float value.
        /// </value>
        /// <exception cref="System.OverflowException">value is greater than UInt32.MaxValue ot less than UInt32.MinValue</exception>
        [DebuggerHidden]
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        [DebuggerStepThrough]
        public ulong GetAndSet(ulong newValue)
        {
            ulong result = mValue;
            mValue = newValue;
            return result;
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        [DebuggerStepThrough]
        public ulong GetAndAdd(ulong delta)
        {
            ulong result = mValue;
            mValue = mValue + delta;
            return result;
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        [DebuggerStepThrough]
        public ulong AddAndGet(ulong delta)
        {
            mValue = mValue + delta;
            return mValue;
        }
